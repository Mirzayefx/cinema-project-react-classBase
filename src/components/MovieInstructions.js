...
import PosterImg from "../images/movie-poster.png";
export class MovieInstructions extends Component {
  render() {
    return (
      <div className="movie_ins_container">
        <img src={PosterImg} alt="" />
        <div className="movie_ins_col">
        ...
        <div className="movie_ins_col">
          <span>Movie</span><svg width="35" height="35" viewBox="0 0 35 35" fill="none" xmlns="http://www.w3.org/2000/svg">
