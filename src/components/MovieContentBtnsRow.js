...
export class MovieContentBtnsRow extends Component {
  render() {
    return (
      <div className="movie_content_btns">
        <button className="ent_reg_btn movive_content_btn"><i  className="fas fa-play"></i>Play</button>
        <div className="content_btns_row">
          <a className="icon_shadow shadow_content" href="#">
          <svg
            width="28"
            height="24"
            viewBox="0 0 28 24"
          ...
          <a style={{border: "2px solid var(--red)"}} className="icon_shadow shadow_content" href="#">
          <svg
            width="16"
            height="25"
            viewBox="0 0 16 25"
          ...
          >
            <path
              d="M15.5 1H1.5H1L1.5 23.7514L8.5 17.6383L15.5 23.7514V1Z"
              fill="#C00511"
              stroke="#C00511"
            />
          </svg>
...
export default MovieContentBtnsRow;
